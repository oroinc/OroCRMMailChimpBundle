...
class OroCRMMailChimpBundleInstaller implements Installation
{
    ...
    public function up(Schema $schema, QueryBag $queries)
    {
        ...
        $this->createOrocrmMcMmbrActivityTable($schema);
        $this->createOrocrmMcStaticSegmentMmbrTable($schema);
        $this->createOrocrmMailchimpTemplateTable($schema);
        $this->createOrocrmMcStaticSegmentTable($schema);
        $this->createOrocrmMcSubscribersListTable($schema);
        ...
        $this->addOrocrmMcMmbrActivityForeignKeys($schema);
        $this->addOrocrmMcStaticSegmentMmbrForeignKeys($schema);
        $this->addOrocrmMailchimpTemplateForeignKeys($schema);
        $this->addOrocrmMcStaticSegmentForeignKeys($schema);
        $this->addOrocrmMcSubscribersListForeignKeys($schema);
     ...
     * @param Schema $schema
     */
    protected function createOrocrmMcMmbrActivityTable(Schema $schema)
    {
     ...
     * @param Schema $schema
     */
    protected function createOrocrmMcStaticSegmentMmbrTable(Schema $schema)
    {
     ...
     * @param Schema $schema
     */
    protected function createOrocrmMcStaticSegmentTable(Schema $schema)
    {
     ...
     * @param Schema $schema
     */
    protected function createOrocrmMcSubscribersListTable(Schema $schema)
    {
     ...
     * @param Schema $schema
     */
    protected function addOrocrmMcMmbrActivityForeignKeys(Schema $schema)
    {
     ...
     * @param Schema $schema
     */
    protected function addOrocrmMcStaticSegmentMmbrForeignKeys(Schema $schema)
    {
     ...
     * @param Schema $schema
     */
    protected function addOrocrmMcStaticSegmentForeignKeys(Schema $schema)
    {
     ...
     * @param Schema $schema
     */
    protected function addOrocrmMcSubscribersListForeignKeys(Schema $schema)
    {
